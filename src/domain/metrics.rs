...
pub mod units {
    ...
    pub fn bytes() -> MetricUnit { MetricUnit::Bytes(BytesUnit::Byte) }
    pub fn kib() -> MetricUnit { MetricUnit::Bytes(BytesUnit::KibiByte) }
    pub fn mib() -> MetricUnit { MetricUnit::Bytes(BytesUnit::MebiByte) }
    pub fn gib() -> MetricUnit { MetricUnit::Bytes(BytesUnit::GibiByte) }

    // Time-related helper functions
    pub fn nanoseconds() -> MetricUnit { MetricUnit::Time(TimeUnit::Nanosecond) }
    pub fn microseconds() -> MetricUnit { MetricUnit::Time(TimeUnit::Microsecond) }
    pub fn milliseconds() -> MetricUnit { MetricUnit::Time(TimeUnit::Millisecond) }
    pub fn seconds() -> MetricUnit { MetricUnit::Time(TimeUnit::Second) }
    pub fn minutes() -> MetricUnit { MetricUnit::Time(TimeUnit::Minute) }
    pub fn hours() -> MetricUnit { MetricUnit::Time(TimeUnit::Hour) }
    pub fn days() -> MetricUnit { MetricUnit::Time(TimeUnit::Day) }

    // Percentage-related helper functions
    pub fn percent() -> MetricUnit { MetricUnit::Percentage(PercentageUnit::Percent) }
    pub fn fraction() -> MetricUnit { MetricUnit::Percentage(PercentageUnit::Fraction) }

    // Network-related helper functions
    pub fn requests() -> MetricUnit { MetricUnit::Network(NetworkUnit::Request) }
    pub fn connections() -> MetricUnit { MetricUnit::Network(NetworkUnit::Connection) }
    pub fn packets() -> MetricUnit { MetricUnit::Network(NetworkUnit::Packet) }

    // System-related helper functions
    pub fn processes() -> MetricUnit { MetricUnit::System(SystemUnit::Process) }
    pub fn threads() -> MetricUnit { MetricUnit::System(SystemUnit::Thread) }
    pub fn hosts() -> MetricUnit { MetricUnit::System(SystemUnit::Host) }

    // General helper functions
    pub fn operations() -> MetricUnit { MetricUnit::General(GeneralUnit::Operation) }
    pub fn errors() -> MetricUnit { MetricUnit::General(GeneralUnit::Error) }
    pub fn events() -> MetricUnit { MetricUnit::General(GeneralUnit::Event) }
}